...
if not auth_code:
    ...
    # Playlist Section
    st.markdown("<h3 class='playlist-header'>Your Playlists</h3>", unsafe_allow_html=True)
    playlists = sp.current_user_playlists()
    for playlist in playlists['items']:
        st.markdown(f"""
        <div class='playlist-item'>
            <img src='{playlist['images'][0]['url']}' alt='Playlist Cover'>
            <h4>{playlist['name']} ({playlist['tracks']['total']} tracks)</h4>
        </div>
        """, unsafe_allow_html=True)
...
days_of_week = [
    {"day": "Monday", "image": "https://via.placeholder.com/150", "text": "Motivation Monday"},
    {"day": "Tuesday", "image": "https://via.placeholder.com/150", "text": "Tune Tuesday"},
    {"day": "Wednesday", "image": "https://via.placeholder.com/150", "text": "Wellness Wednesday"},
    {"day": "Thursday", "image": "https://via.placeholder.com/150", "text": "Throwback Thursday"},
    {"day": "Friday", "image": "https://via.placeholder.com/150", "text": "Feel-Good Friday"},
    {"day": "Saturday", "image": "https://via.placeholder.com/150", "text": "Sunny Saturday"},
